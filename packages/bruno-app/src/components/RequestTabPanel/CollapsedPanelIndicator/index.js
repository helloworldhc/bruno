...
const CollapsedPanelIndicator = ({
  ...
  const label = panelType === 'request' ? t('REQUEST_TAB_PANEL.REQUEST', 'Request') : t('REQUEST_TAB_PANEL.RESPONSE', 'Response');
  ...
  return (
    <StyledWrapper
      ...
      aria-label={t('REQUEST_TAB_PANEL.EXPAND_PANE', `Expand ${label} pane`, { label })}
      title={t('REQUEST_TAB_PANEL.EXPAND_PANE_HINT', `Click to expand ${label} pane, or drag to resize`, { label })}
    >
