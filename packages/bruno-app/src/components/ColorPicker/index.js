...
const ColorPicker = ({ color, onChange, icon }) => {
  ...
  const defaultIcon = (
    <div className="cursor-pointer flex items-center" title={t('COLOR_PICKER.CHANGE_COLOR', 'Change color')}>
      ...
      <div className="p-2">
        <div className="flex flex-wrap gap-1.5 justify-between items-center">
          <div
            ...
            title={t('COLOR_PICKER.NO_COLOR', 'No color')}
          >
        ...
        <div className="flex items-center gap-2 mt-2 pt-0.5">
          <div
            ...
            title={t('COLOR_PICKER.CUSTOM_COLOR', 'Custom color')}
          />
          <ColorRangePicker
