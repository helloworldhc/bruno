...
const ResponsePaneActions = ({ item, collection, responseSize, selectedFormat, selectedTab, data, dataBuffer }) => {
  ...
  const gqlMenuItems = [
    {
      id: 'copy-response',
      label: t('RESPONSE.COPY_RESPONSE', 'Copy response'),
    ...
    },
    {
      ...
      label: t('RESPONSE.DOWNLOAD_RESPONSE', 'Download response'),
    ...
    {
      id: 'clear-response',
      label: t('RESPONSE.CLEAR_RESPONSE', 'Clear response'),
    ...
    {
      id: 'change-layout',
      label: t('RESPONSE.CHANGE_LAYOUT', 'Change layout'),
  ...
  const menuItems = [
    ...
    {
      id: 'save-response',
      label: t('RESPONSE.SAVE_RESPONSE', 'Save response'),
