  ...
  return (
    <StyledWrapper className="w-full card my-2">
      <div className="flex items-center gap-2 px-3 py-2 title">
        ...
        <span className="font-medium">{t('COLLECTION_SETTINGS.REQUESTS_NOT_LOADED_TITLE', 'Following requests were not loaded')}</span>
      </div>
      <table className="w-full border-collapse">
        <thead>
          <tr>
            <th className="py-2 px-3 text-left font-medium">
              {t('COLLECTION_SETTINGS.PATHNAME', 'Pathname')}
            </th>
            <th className="py-2 px-3 text-left font-medium">
              {t('COLLECTION_SETTINGS.SIZE', 'Size')}
            </th>
          </tr>
        </thead>
        <tbody>
