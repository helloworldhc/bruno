          ...
          <div className="provider-body flex flex-col gap-3.5 px-3 pt-3 pb-3">
            ...
            <div>
              <div className="key-section-label flex items-center justify-between gap-2 text-[11px] mb-1">
                <span>{t('PREFERENCES.AI_API_KEY', 'API Key')}</span>
              </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-0.5">
                    <button
                      ...
                      title={t('PREFERENCES.AI_TEST_CONNECTION', 'Test connection')}
                    ...
                    <button
                      ...
                      title={t('PREFERENCES.AI_REPLACE_KEY', 'Replace key')}
                      aria-label={t('PREFERENCES.AI_REPLACE_KEY', 'Replace key')}
                    >
                      <IconPencil size={15} />
                    </button>
                    <button
                ...
                <div className="models-label-row flex items-center justify-between text-[11px]">
                  ...
                  {!provider.configured && (
                    <span className="keyless-hint flex items-center gap-1.5 text-[11px] py-1">
                      ...
                      {t('PREFERENCES.AI_ADD_KEY_TO_ENABLE', 'Add an API key to enable')}
                    </span>
                  )}
                </div>
