...
const ImportCollection = ({ onClose, handleSubmit }) => {
  ...
  return (
    <Portal>
      <Modal size="md" title={t('IMPORT_COLLECTION.TITLE', 'Import Collection')} hideFooter={true} handleCancel={onClose} dataTestId="import-collection-modal">
          ...
          <div className="flex w-full mb-6">
            <div className="flex justify-start w-full tabs">
              ...
              >
                ...
                {t('SIDEBAR.CLONE_GIT', 'Git Repository')}
              </div>
              <div
