      ...
      <div className="terminal-content">
        ...
        <div className="terminal-sessions-sidebar">
          <div className="terminal-sessions-header">
            <span>{t('DEVTOOLS.TERMINAL.SESSIONS', 'Sessions')}</span>
            <IconPlus
              size={16}
              ...
              title={t('DEVTOOLS.TERMINAL.NEW_SESSION', 'New Terminal Session')}
            />
          </div>
          <div className="terminal-sessions-list">
            {isLoading ? (
              <div style={{ padding: '12px', color: '#888', fontSize: '13px' }}>{t('DEVTOOLS.TERMINAL.LOADING_SESSIONS', 'Loading sessions...')}</div>
            ) : sessions.length === 0 ? (
              <div style={{ padding: '12px', color: '#888', fontSize: '13px' }}>{t('DEVTOOLS.TERMINAL.NO_ACTIVE_SESSIONS', 'No active sessions')}</div>
            ) : (
              <SessionList
                sessions={sessions}
        ...
        <div className="terminal-display-container">
          {!activeSessionId && window.ipcRenderer && (
            <div className="terminal-loading">
              ...
              <span>{t('DEVTOOLS.TERMINAL.NO_SESSION_SELECTED', 'No terminal session selected')}</span>
            </div>
          )}
          <div
            ref={onSessionMount}
